...
async def parse_main_category_page(main_url="https://kulinaria.ge/receptebi/cat/msoplio-samzareulo/"):
    """
...
async def return_every_parse() -> tuple[Any]:
    ...
    """
    list_of_urls = await parse_main_category_page()
    tasks = [parse_recipe(WEBSITE + url) for url in list_of_urls]
...
if __name__ == "__main__":
    ...
    recipes = loop.run_until_complete(return_every_parse())
    print(recipes)
